...
LANG_KEY_ENUM(
	...
	BuffRelicVass,
	BuffRelicNourys,
	BuffRelicStormsinger,
	BuffRelicSorrow,
	BuffRelicBlightbringer,
	BuffRelicClaw,
	BuffRelicMountBalrior,
	BuffRelicThorns,
	BuffRelicTitanicPotential,
	BuffRelicSoulOfTheTitan,
	BuffRelicBloodstoneVolatility,
	BuffRelicBloodstoneFervor,
...
private:
	std::map<LangKey, std::string> langMap{
		...
		{LangKey::BuffRelicAristocracy, "Relic of the Aristocracy"},
		{LangKey::BuffRelicMonk, "Relic of the Monk"},
		{LangKey::BuffRelicBrawler, "Relic of the Brawler"},
		{LangKey::BuffRelicThief, "Relic of the Thief"},
		{LangKey::BuffRelicFireworks, "Relic of Fireworks"},
		{LangKey::BuffRelicDaredevil, "Relic of the Daredevil"},
		{LangKey::BuffRelicDeadeye, "Relic of the Deadeye"},
		{LangKey::BuffRelicFirebrand, "Relic of the Firebrand"},
		{LangKey::BuffRelicHerald, "Relic of the Herald"},
		{LangKey::BuffRelicScourge, "Relic of the Scourge"},
		{LangKey::BuffRelicWeaver, "Relic of the Weaver"},
		{LangKey::BuffRelicZephyrite, "Relic of the Zephyrite"},
		{LangKey::BuffRelicLyhr, "Relic of Lyhr"},
		{LangKey::BuffRelicMabon, "Relic of Mabon"},
		{LangKey::BuffRelicVass, "Relic of Vass"},
		{LangKey::BuffRelicNourys, "Relic of Nourys"},
		{LangKey::BuffRelicStormsinger, "Relic of the Stormsinger"},
		{LangKey::BuffRelicSorrow, "Relic of Sorrow"},
		{LangKey::BuffRelicBlightbringer, "Relic of the Blightbringer"},
		{LangKey::BuffRelicClaw, "Relic of the Claw"},
		{LangKey::BuffRelicMountBalrior, "Relic of Mount Balrior"},
		{LangKey::BuffRelicThorns, "Relic of Thorns"},
		{LangKey::BuffRelicTitanicPotential, "Relic of the Living City"},
		{LangKey::BuffRelicSoulOfTheTitan, "Soul Of The Titan"},
		{LangKey::BuffRelicBloodstoneVolatility, "Relic of Bloodstone - Volatility"},
		{LangKey::BuffRelicBloodstoneFervor, "Relic of Bloodstone - Fervor"},
